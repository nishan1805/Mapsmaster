      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-8 lg:px-12">
        <div className="bg-gray-50 rounded-[3rem] overflow-hidden shadow-sm border border-gray-100">
          <div className="flex flex-col lg:flex-row">
            <div className="lg:w-[35%] p-10 lg:p-16 bg-navy text-white flex flex-col justify-center">
              ...
              <p className="text-gray-400 mb-12 text-lg leading-relaxed">
                Tell us about your business goals. Our team in Raipur will analyze your profile and help you get discovered by thousands of active customers.
              </p>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-6 group cursor-pointer">
                  ...
                  <div>
                    <h6 className="font-bold text-sm uppercase tracking-widest text-gray-500">Call Us</h6>
                ...
                <div className="flex items-center gap-6 group cursor-pointer">
                  ...
                  <div>
                    <h6 className="font-bold text-sm uppercase tracking-widest text-gray-500">Email Us</h6>
                    <p className="text-white text-lg">hello@mapsmaster.in</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="lg:w-[65%] p-10 lg:p-20 bg-white">
